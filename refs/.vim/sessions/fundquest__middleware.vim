...
badd +205 src/main/java/com/secondcaesar/T24Connect.java
badd +47 src/main/java/com/secondcaesar/InvestmentService.java
badd +1 src/main/java/com/secondcaesar/FundQuestService.java
badd +1 src/main/java/com/secondcaesar/InvestmentProduct.java
argglobal
%argdel
edit src/main/java/com/secondcaesar/T24Connect.java
...
wincmd w
argglobal
balt src/main/java/com/secondcaesar/InvestmentService.java
setlocal fdm=syntax
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 382 - ((0 * winheight(0) + 23) / 47)
