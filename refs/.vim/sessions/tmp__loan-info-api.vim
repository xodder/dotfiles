...
badd +1 src/modules/loan-request/loan-request.routes.ts
badd +9 src/modules/loan-request/guarantor/guarantor.routes.ts
...
badd +6 term://~/Workspace/moniepoint/tmp/loan-info-api//40102:/bin/zsh
badd +1 src/modules/loan/loan.data.json
badd +28 src/modules/loan/data/loan.overdraft.data.ts
badd +26 src/modules/brm-prequalification/brm-prequalification.types.ts
badd +1 src/modules/brm-prequalification/brm-prequalification.routes.ts
badd +1 src/modules/brm-prequalification/data/brm-prequalification.data.ts
badd +1 src/modules/bo-prequalification/bo-prequalification.routes.ts
badd +17 src/modules/bo-prequalification/bo-prequalification.types.ts
badd +1 ~/Workspace/moniepoint/tmp/loan-info-api/src/modules/bo-prequalification/data/bo-prequalification.data.ts
argglobal
%argdel
$argadd ~/Workspace/moniepoint/tmp/loan-info-api/src/modules/bo-prequalification/data/bo-prequalification.data.ts
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit src/modules/loan-request/loan-request.routes.ts
...
wincmd w
argglobal
balt src/modules/loan-request/guarantor/data/guarantor-slot.data.ts
setlocal fdm=indent
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
wincmd w
argglobal
if bufexists(fnamemodify("src/modules/loan-request/guarantor/guarantor.types.ts", ":p")) | buffer src/modules/loan-request/guarantor/guarantor.types.ts | else | edit src/modules/loan-request/guarantor/guarantor.types.ts | endif
if &buftype ==# 'terminal'
  silent file src/modules/loan-request/guarantor/guarantor.types.ts
endif
balt src/modules/loan-request/guarantor/data/guarantor-slot.data.ts
setlocal fdm=indent
setlocal fde=0
...
setlocal fdn=20
setlocal fen
let s:l = 81 - ((51 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 81
